...
public class AdopetConsoleApplication {
    ...
    public static HttpResponse<String> dispararGet(HttpClient client, String uri) throws  IOException, InterruptedException{
    ...
    public static HttpResponse<String> dispararPost(HttpClient client, String uri, JsonObject json) throws IOException, InterruptedException{
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(uri))
